...
const handleLogout = () => {
  logoutMutate(localStorage.removeItem("user"))
}


  return (
    <>
    <div className={`${!toogleSidebar && "hidden"} sidebar xl:hidden lg:hidden absolute z-50 right-0 bg-stone-50 w-[220px] sm:mr-8 md:mr-8`}>
        ...
        {!user ? (<>
            ...
            <li className="border-b border-opacity-20 border-gray-800 py-3 pl-10 shadow-bold"><a href="courses-search.html">Courses</a></li>
            <li className="border-b border-opacity-20 border-gray-800 py-3 pl-10 shadow-bold"><a href="academy-details.html">Academies</a></li>
            ...
            <li className="border-b border-opacity-20 border-gray-800 py-3 pl-10 shadow-bold"><a href="">About</a></li>
            <li className="border-b border-opacity-20 border-gray-800 py-3 pl-10 shadow-bold"><a href="">Contact</a></li>
